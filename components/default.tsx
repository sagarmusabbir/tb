    ...
    <MegaMenu className="dark:bg-gray-800 sticky top-0 z-50">
      <NavbarBrand href="/">
        ...
        /> */}
         ...
         <LogoIcon className="stroke-primary-400 dark:stroke-primary-600 mr-2 fill-primary-400  dark:fill-primary-600 p-0.5 h-6 w-6 sm:w-9 sm:h-9 bg-gray-800 dark:bg-gray-200  rounded-md  " />
